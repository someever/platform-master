                ...
                <div class="panel-body">
                    <div class="clearfix">
                        <div class="btn-group" style="margin-top: 18px;">
                            ...
                            <a class="btn btn-info" ng-click="pocApplyFor()"><span
                                    translate="load.oneKeyApplyFor"></span>&nbsp<i class="fa fa-flag"></i></a>
                    ...
                    <table class="table  table-hover general-table">
                        ...
                        <tr ng-repeat="application in applicationDatas">
                            ...
                            <td style="vertical-align:middle;cursor:pointer" title={{application.mailOrder.areaIds}}>
                                {{application.mailOrder.areaIds}}
                            </td>
                            ...
                            <td><a ng-click="updateClicked(application.mailOrder.id)"
                                   ng-hide="application.approvalStatus==2 || application.approvalStatus==3 "
                                   style="cursor:pointer;color: navy"><span translate="load.update"></span><i
                                    class="fa fa-edit"></i></a>
                                <a ng-click="updateClickedSee(application.mailOrder.id)"
                                   ng-hide="application.approvalStatus==1 || application.approvalStatus==4"
                                   style="cursor:pointer;color: navy"><span translate="load.applicationSee"></span><i
                                        class="fa fa-eye"></i></a>
                                <a ng-click="applyFor(application.mailOrder.id)"
                                   ng-hide="application.approvalStatus==2 || application.approvalStatus==3 "
                                   style="cursor:pointer;"><span translate="load.ApplyFor"></span><i
                                        class="fa fa-check"></i></a>
                                <a ng-click="approvalForEye(application.mailOrder.id)"
                                   ng-hide="application.approvalStatus==1 || application.approvalStatus==4 || application.approvalStatus==2"
                                   style="cursor:pointer;color:#55b2ff"><span translate="load.GetApprovalFrom"></span><i
                                        class="fa fa-eye"></i></a>
                            </td>
                        </tr>
                    ...
                    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="${ctx}/operation/article/upload" name="fileImportForms"
                                          target="_blank" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label><span
                                                            translate="load.applicationReasons"></span>:</label></span>
                                                    <textarea class="form-control applyReason"
                                                              style="height: 150px;resize:none;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <a class="btn btn-info" href="${ctx}/operation/article/download"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal"><span
                                            translate="load.Cancel"></span></button>
                                    <button type="button" class="btn btn-warning" data-dismiss="modal"
                                            ng-click="confirmApplyFor()"><span translate="load.Ok"></span></button>
                                </div>
                            </div>
                        </div>
                    </div>
